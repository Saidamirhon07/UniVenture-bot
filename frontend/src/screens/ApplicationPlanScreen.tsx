  ...
  return <div className="page-enter space-y-3 flight-plan-screen">
    ...
    {!result ? <>
      ...
      <Card className="flight-builder">
        ...
        <div className="form-grid two"><Input label="Nearest deadline" type="date" value={form.deadline} onChange={(event) => update("deadline", event.target.value)} /><Input label="Hours available / week" type="number" min={1} max={80} value={form.weekly_hours} onChange={(event) => update("weekly_hours", event.target.value)} /></div>
